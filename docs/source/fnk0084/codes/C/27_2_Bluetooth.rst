...
Compile and upload code to ESP32S3_Blueooth. The operation of the APP is the same as 13.1, you only need to change the sending content to "led_on" and "led_off" to operate LEDs on the ESP32-S3 WROOM. Data sent from mobile APP:
...
.. literalinclude:: ../../../freenove_Kit/C/Sketches/Sketch_13.2_BluetoothToLed/Sketch_13.2_BluetoothToLed.ino
    :linenos: 
    :language: c
    :dedent:
