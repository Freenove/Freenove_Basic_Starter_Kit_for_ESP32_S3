...
Open the " **Freenove_Basic_Starter_Kit_for_ESP32_S3\\Sketches\\Sketches\\Sketch_31.1_WiFiClient\\sketchWiFi\\sketchWiFi.pde** ", and click "Run".
...
.. literalinclude:: ../../../freenove_Kit/Python/Python_Codes/14.1_TCP_as_Client/TCP_as_Client.py
    :linenos: 
    :language: python
    :dedent:
...
Open the “Freenove_Basic_Starter_Kit_for_ESP32_S3/Codes/MicroPython_Codes/TCP_as_Server/sketchWiFi/sketchWiFi.pde”.
...
.. literalinclude:: ../../../freenove_Kit/Python/Python_Codes/14.2_TCP_as_Server/TCP_as_Server.py
    :linenos: 
    :language: python
    :dedent:
