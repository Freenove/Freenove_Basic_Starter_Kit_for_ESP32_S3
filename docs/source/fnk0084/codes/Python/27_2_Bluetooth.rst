...
Compile and upload code to ESP32S3. The operation of the APP is the same as 12.1, you only need to change the sending content to "led_on" and "led_off" to operate LEDs on the ESP32S3.
...
.. literalinclude:: ../../../freenove_Kit/Python/Python_Codes/12.2_BLE_LED/BLE_LED.py
    :linenos: 
    :language: python
    :dedent:
