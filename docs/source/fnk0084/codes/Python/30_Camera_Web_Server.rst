...
Project 15.1 Camera Web Server
*************************************
...
Open "Thonny", click "This computer" -> "D:" -> "Micropython_Codes" -> "15.1_Camera_WebServer". Select folder "**lib**", right click your mouse to select "Upload to /", wait for "**lib**" to be uploaded to ESP32-WROVER and then double click "**picoweb_video.py**".

15.1_Camera_WebServer
--------------------------
...
.. literalinclude:: ../../../freenove_Kit/Python/Python_Codes/15.1_Camera_WebServer/picoweb_video.py
    :linenos: 
    :language: python
    :lines: 1-118
    :dedent:
